...
namespace VDLaser.ViewModel
{
    public class MainViewModel:ViewModelBase
    {
        ...
        private List<SettingItems> _listGrblSettings = new List<SettingItems>();
        private Queue<string> _fileQueue = new Queue<string>();
        private List<string> _fileList = new List<string>();
        private ObservableCollection<ConsoleItems> _consoleData;
        private ObservableCollection<GCodeItems> _gcodeData;
        private ObservableCollection<GraphicItems> _paths = new ObservableCollection<GraphicItems>();
        private List<ConsoleItems> _listConsoleData = new List<ConsoleItems>();
        private ConsoleItems _console = new ConsoleItems("TX", "RX");
        private GCodeItems _gcodeModel;
        ...
        public List<SettingItems> ListSetting
        {
            ...
            set
            {
                Set<List<SettingItems>>(() => this.ListSetting, ref _listGrblSettings, value);
        ...
        /// Changes to that property's value raise the PropertyChanged event. 
        /// </summary>
        public List<ConsoleItems> ListConsoleData
        {
            get
            {
        ...
        /// Changes to that property's value raise the PropertyChanged event. 
        /// </summary>
        public ObservableCollection<ConsoleItems> ConsoleData
        {
            get
            {
                return _consoleData;
        ...
        public ObservableCollection<GCodeItems> GCodeData
        {
            get
            {
                return _gcodeData;
        ...
        {
            MessengerInstance.Send<PropertyChangedMessage<List<SettingItems>>>(new PropertyChangedMessage<List<SettingItems>>(null, this.ListSetting, nameof(ListSetting)));
        ...
        {
            string mes = "Copyright @ 2021 VDLaser" + Environment.NewLine + "Version: " + VersionVD + Environment.NewLine + "Grbl v0.9 and v1.1";
        ...
        private void LoadFile(string fileName)
        {
            ...
            using (StreamReader sr = new StreamReader(fileName))
            {
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    GCodeModel = new GCodeItems(i, line);
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            Console = new ConsoleItems(TXLine, RXLine);
            if (IsVerbose)
            {
            ...
            ConsoleData = new ObservableCollection<ConsoleItems>(ListConsoleData);
